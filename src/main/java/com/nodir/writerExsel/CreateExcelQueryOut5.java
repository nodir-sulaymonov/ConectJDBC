...
public class CreateExcelQueryOut5 {
    ...
    public void excelQueryOut5() throws IOException {

        HSSFWorkbook hssfWorkbook = new HSSFWorkbook();
        HSSFSheet sheet = hssfWorkbook.createSheet("out Moskow");
        ...
        File file = new File("QueryExcel\\QueryOut5.xls");
